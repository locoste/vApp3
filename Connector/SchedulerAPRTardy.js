...
exports.getProductionPlanning=function(art, datedem, qteDem, mo, company, callback){
  var tabLink=[];
  var tabNode=[];
  var res;
  try {
...
//getProductionPlanning("8111", "2015-07-28", "2", "1300", "APR", function(result){console.log(JSON.stringify(result))});